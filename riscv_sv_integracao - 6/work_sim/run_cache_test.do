...
add wave -position insertpoint -divider "PERFORMANCE" \
sim:/tb/DUT/cpu1/riscv_fetch/inst_counter \
sim:/tb/DUT/cpu1/riscv_fetch/clk_counter \
sim:/tb/DUT/M1/miss_reg \
sim:/tb/DUT/M1/access_reg 
